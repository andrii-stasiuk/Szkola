...
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
   TelefonKreglarza, IDDruzyny)
...
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
   TelefonKreglarza, IDDruzyny)
  VALUES (5, 'Patterson', 'Ann', 'K', '16 Maple Tor', 
   'Auburn', 'WA', '98002', '(206) 555-3487', NULL);
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
   TelefonKreglarza, IDDruzyny)
  VALUES (6, 'Patterson', 'Neil', NULL, '16 Maple Tor', 
   'Auburn', 'WA', '98002', '(206) 555-3487', NULL);
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
...
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
   TelefonKreglarza, IDDruzyny)
  VALUES (15, 'Patterson', 'Kathryn', NULL, '16 Maple Tor', 
   'Auburn', 'WA', '98002', '(206) 555-3487', NULL);
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
...
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
   TelefonKreglarza, IDDruzyny)
  VALUES (25, 'Patterson', 'Megan', NULL, '16 Maple Tor', 
   'Auburn', 'WA', '98002', '(206) 555-3487', NULL);
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
...
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
   TelefonKreglarza, IDDruzyny)
  VALUES (30, 'Patterson', 'Rachel', NULL, '16 Maple Tor', 
   'Auburn', 'WA', '98002', '(206) 555-3487', NULL);
INSERT INTO Kreglarze
  (IDKreglarza, NazwiskoKreglarza, ImieKreglarza, SrodkowyInicjalKreglarza, 
   AdresKreglarza, MiastoKreglarza, StanZamKreglarza, KodPocztowyKreglarza, 
...
INSERT INTO Druzyny
  (IDDruzyny, NazwaDruzyny, IDKapitana)
  VALUES (1, 'Marlins', 2);
INSERT INTO Druzyny
  (IDDruzyny, NazwaDruzyny, IDKapitana)
  VALUES (2, 'Sharks', 5);
...
UPDATE Kreglarze 
SET IDDruzyny = 1
WHERE IDKreglarza IN (1, 2, 3, 4);
UPDATE Kreglarze 
SET IDDruzyny = 2
WHERE IDKreglarza IN (5, 6, 7, 8);
UPDATE Kreglarze 
SET IDDruzyny = 3
WHERE IDKreglarza IN (9, 10, 11, 12);
UPDATE Kreglarze 
SET IDDruzyny = 4
WHERE IDKreglarza IN (13, 14, 15, 16);
UPDATE Kreglarze 
SET IDDruzyny = 5
WHERE IDKreglarza IN (17, 18, 19, 20);
UPDATE Kreglarze 
SET IDDruzyny = 6
WHERE IDKreglarza IN (21, 22, 23, 24);
UPDATE Kreglarze 
SET IDDruzyny = 7
WHERE IDKreglarza IN (25, 26, 27, 28);
UPDATE Kreglarze 
SET IDDruzyny = 8
WHERE IDKreglarza IN (29, 30, 31, 32);
INSERT INTO Mecze_turniejowe
  (IDMeczu, IDTurnieju, Tory, IDDruzynyTorNieparzysty, IDDruzynyTorParzysty)
...
INSERT INTO Gry_meczowe
  (IDMeczu, NumerGry, IDWygranejDruzyny)
  VALUES (1, 1, 1);
INSERT INTO Gry_meczowe
  (IDMeczu, NumerGry, IDWygranejDruzyny)
  VALUES (1, 2, 2);
...
INSERT INTO Gry_meczowe
  (IDMeczu, NumerGry, IDWygranejDruzyny)
  VALUES (56, 3, 8);
INSERT INTO Wyniki_kreglarzy
  (IDMeczu, NumerGry, IDKreglarza, WynikCzysty, WynikHandicap, 
   GraWygrana)
...
INSERT INTO ztblPoziomKreglarza
  (PoziomKreglarza, SredniaNiskaKreglarza, SredniaWysokaKreglarza)
...
INSERT INTO ztblPomijanieEtykiet
  (LicznikEtykiet)
  VALUES (1);
INSERT INTO ztblPomijanieEtykiet
  (LicznikEtykiet)
...
INSERT INTO ztblPomijanieEtykiet
  (LicznikEtykiet)
  VALUES (60);
INSERT INTO ztblTygodnie
  (PoczatekTygodnia, KoniecTygodnia)
